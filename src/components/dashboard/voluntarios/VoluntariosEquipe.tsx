    ...
    },
    {
      ...
      render: (item) => (
        <div className="text-xs min-w-0">
          ...
          <p className="text-[11px] text-[var(--color-primary)] font-semibold truncate">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <Card className="p-4 sm:p-5 flex items-center gap-3.5 border-l-4 border-l-[var(--color-primary)]">
        ...
        <Card className="p-4 sm:p-5 flex items-center gap-3.5 border-l-4 border-l-[#93368F]">
          <div className="w-11 h-11 rounded-2xl bg-[#93368F]/10 text-[#93368F] flex items-center justify-center shrink-0">
        ...
        <Card className="p-4 sm:p-5 flex items-center gap-3.5 border-l-4 border-l-amber-500">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xl sm:text-2xl font-display font-extrabold text-[var(--text-primary)]">
              {todasHabilidades.length > 0 ? todasHabilidades.length : '100% Equipe'}
            </p>
          </div>
        </Card>
      </div>

      {/* ── 2. PAINEL DE BUSCA & FILTROS ── */}
      <div className="p-4 sm:p-5 rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-default)] shadow-[var(--shadow-card)] space-y-3">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              type="text"
              placeholder="Buscar por nome, CPF, e-mail ou função..."
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              className="w-full pl-9 pr-3 py-2 rounded-xl text-xs bg-[var(--bg-secondary)] text-[var(--text-primary)] border border-[var(--border-default)] placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--color-primary)] transition-all"
            />
          </div>
